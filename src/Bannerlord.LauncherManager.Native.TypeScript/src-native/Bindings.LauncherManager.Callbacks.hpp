...
namespace Bindings::LauncherManager
{
    ...
    static return_value_void *setGameParameters(param_ptr *p_owner, param_string *p_executable, param_json *p_game_parameters, param_ptr *p_callback_handler, void (*p_callback)(param_ptr *, return_value_void *)) noexcept
    {
        ...
        return NonBlockingVoidCallback(__FUNCTION__, manager, manager->TSFN, p_callback_handler, p_callback,
    ...
    {
        auto manager = GetManager(p_owner);
        return NonBlockingStringPromiseCallback(__FUNCTION__, manager, manager->TSFN, p_callback_handler, p_callback,
                                                [p_type, p_title, p_message, p_filters](auto *mgr)
                                                {
                                                    const auto env = mgr->FSendDialog.Env();
                                                    return mgr->FSendDialog.Call({
    ...
    {
        auto manager = GetManager(p_owner);
        return BlockingCallback<return_value_string>(__FUNCTION__, manager, manager->TSFNGetInstallPath, p_callback_handler, p_callback,
    ...
    {
        auto manager = GetManager(p_owner);
        return BlockingCallback<return_value_data>(__FUNCTION__, manager, manager->TSFNReadFileContent, p_callback_handler, p_callback,
    ...
    {
        auto manager = GetManager(p_owner);
        return BlockingCallback<return_value_void>(__FUNCTION__, manager, manager->TSFNWriteFileContent, p_callback_handler, p_callback,
    ...
    {
        auto manager = GetManager(p_owner);
        return BlockingCallback<return_value_json>(__FUNCTION__, manager, manager->TSFNReadDirectoryFileList, p_callback_handler, p_callback,
    ...
    {
        auto manager = GetManager(p_owner);
        return BlockingCallback<return_value_json>(__FUNCTION__, manager, manager->TSFNReadDirectoryList, p_callback_handler, p_callback,
                                                   [p_directory_path, p_callback_handler, p_callback](auto *mgr)
                                                   {
    ...
    {
        auto manager = GetManager(p_owner);
        return BlockingCallback<return_value_json>(__FUNCTION__, manager, manager->TSFNGetAllModuleViewModels, p_callback_handler, p_callback,
                                                   [p_callback_handler, p_callback](auto *mgr)
                                                   {
    ...
    {
        auto manager = GetManager(p_owner);
        return BlockingCallback<return_value_json>(__FUNCTION__, manager, manager->TSFNGetModuleViewModels, p_callback_handler, p_callback,
                                                   [p_callback_handler, p_callback](auto *mgr)
                                                   {
    ...
    {
        auto manager = GetManager(p_owner);
        return BlockingCallback<return_value_json>(__FUNCTION__, manager, manager->TSFNGetOptions, p_callback_handler, p_callback,
                                                   [p_callback_handler, p_callback](auto *mgr)
                                                   {
    ...
    {
        auto manager = GetManager(p_owner);
        return BlockingCallback<return_value_json>(__FUNCTION__, manager, manager->TSFNGetState, p_callback_handler, p_callback,
                                                   [p_callback_handler, p_callback](auto *mgr)
                                                   {
