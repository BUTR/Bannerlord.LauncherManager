...
namespace Bindings::LauncherManager
{
    ...
    static return_value_void *setGameParameters(param_ptr *p_owner, param_string *p_executable, param_json *p_game_parameters, param_ptr *p_callback_handler, void (*p_callback)(param_ptr *, return_value_void *)) noexcept
    {
        ...
        auto callback = [p_executable, p_game_parameters, p_callback_handler, p_callback](auto *mgr)
        {
        ...
        return NonAwaitableVoidCallback(__FUNCTION__, manager, manager->TSFN, p_callback_handler, p_callback, callback);
    }
    ...
    {
        auto manager = GetManager(p_owner);
        auto callback = [p_id, p_type, p_message, displayMs, p_callback_handler, p_callback](auto *mgr)
        {
    ...
    {
        auto manager = GetManager(p_owner);
        auto callback = [p_type, p_title, p_message, p_filters](auto *mgr)
        {
        ...
        return NonAwaitableStringPromiseCallback(__FUNCTION__, manager, manager->TSFN, p_callback_handler, p_callback, callback);
    }
    ...
    {
        auto manager = GetManager(p_owner);
        auto callback = [p_module_view_models, p_callback_handler, p_callback](auto *mgr)
        {
