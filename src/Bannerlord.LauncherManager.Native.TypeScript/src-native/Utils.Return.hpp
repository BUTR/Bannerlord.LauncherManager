...
template <> struct ReturnValueTraits<return_value_void>
{
...
template <> struct ReturnValueTraits<return_value_string>
{
...
template <> struct ReturnValueTraits<return_value_json>
{
...
template <> struct ReturnValueTraits<return_value_bool>
{
...
template <> struct ReturnValueTraits<return_value_int32>
{
...
template <> struct ReturnValueTraits<return_value_uint32>
{
...
template <> struct ReturnValueTraits<return_value_ptr>
{
...
template <typename T> inline decltype(auto) ThrowOrReturnValue(const Env env, T *const result)
{
